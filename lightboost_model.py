# ================================================================
# train_lgb.py  LightGBM 默认 vs 优化  四指标对比
# ================================================================
import pandas as pd
import numpy as np
...
y_pred_proba_def = lgb_default.predict_proba(X_valid)[:, 1]
y_pred_def       = lgb_default.predict(X_valid)
...
y_pred_proba_best = best_lgb.predict_proba(X_valid)[:, 1]
y_pred_best       = best_lgb.predict(X_valid)
...
# ----------------------------------------------------------------
print("--------------- LightGBM 默认参数 ---------------")
print(f"Parameters: {lgb_default.get_params()}")
